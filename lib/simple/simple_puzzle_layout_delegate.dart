...
class _SimplePuzzleTileState extends State<SimplePuzzleTile> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _heartAnimation = Tween(begin: 100.0, end: 70.0).animate(CurvedAnimation(
        ...
        return CustomPaint(
          ...
          child: TextButton(
            ...
            /*  shape: const RoundedRectangleBorder(
              ...
              side: BorderSide(color: Colors.transparent,style: BorderStyle.solid,width: 2)
            ),*/
            ).copyWith(
